    ...
    <main style={styles.page}>
      ...
      {isCartOpen && (
        <div style={styles.overlay} onClick={() => setIsCartOpen(false)}>
          <div style={styles.cartPopup} onClick={(e) => e.stopPropagation()}>
            <div style={styles.popupTitle}>🛒 Mon panier</div>
            <p style={styles.popupText}>Votre panier est vide</p>

            <div style={styles.popupTotal}>Total : 0 FCFA</div>
